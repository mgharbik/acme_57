...
public class AddTechnicalPresenter implements Presenter{
	...
	public AddTechnicalPresenter(UseCaseServiceAsync rpcService, HandlerManager eventBus, AddTechnicalView addView) {
